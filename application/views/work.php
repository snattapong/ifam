  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">แบบบันทึกกลุ่มงาน</h4>
      </div>
      <div class="modal-body">

				<div class="form-group">
					<label for="workName">ชื่อกลุ่มงาน</label>
					<input id="workName" type="text" class="form-control" ></input>
				</div>
				<div class="form-group">
					<label for="speedValue">ความเร็วเอกสาร(วัน)</label>
